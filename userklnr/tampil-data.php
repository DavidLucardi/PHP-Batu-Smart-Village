            ...
            <form class="form-inline" method="POST" action="index.php">
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="cari" placeholder="Cari wisata kuliner..." autocomplete="off" value="<?php echo $cari; ?>">
                </div>
              </div>
            </form>
          </div>
  ...
  ?>
      ...
      <div class="panel panel-primary">
        <div class="panel-heading">
          <h3 class="panel-title">Wisata Kuliner</h3>
        </div>
            ...
            <table class="table table-striped table-hover">
              ...
              if (isset($cari)) {
                $jumlah_record = mysql_query("SELECT COUNT(*) FROM bsv_anggota 
                                              WHERE profil LIKE '%$cari%' AND bidang LIKE 'Kuliner'");
              } else {
                $jumlah_record = mysql_query("SELECT COUNT(*) FROM bsv_anggota");
              }
